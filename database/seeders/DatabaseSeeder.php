...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $questions = [
            ...
            ['pillar_id' => 1, 'text' => 'What is the size of your core leadership team?', 'type' => 'SingleChoice', 'weight' => 6.25, 'options' => [
            ...
            ['pillar_id' => 2, 'text' => 'How many primary revenue streams does your business have?', 'type' => 'Dropdown', 'weight' => 6.25, 'options' => [
            ...
            ['pillar_id' => 3, 'text' => 'Which customer acquisition channels are you currently using?', 'type' => 'MultipleChoice', 'weight' => 6.25, 'options' => [
            ...
            ['pillar_id' => 5, 'text' => 'What is your current order fulfillment process?', 'type' => 'Dropdown', 'weight' => 6.25, 'options' => [
            ...
            ['pillar_id' => 7, 'text' => 'Which digital tools does your company currently use?', 'type' => 'MultipleChoice', 'weight' => 6.25, 'options' => [
            ...
            ['pillar_id' => 8, 'text' => 'What is your primary strategy for scaling the business?', 'type' => 'SingleChoice', 'weight' => 6.25, 'options' => [
        ...
        // 8. Create a Program using the template
